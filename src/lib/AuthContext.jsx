  ...
  const checkAppState = async () => {
    try {
      ...
      try {
        ...
        if (!response.ok) {
          const appError = new Error('Failed to load app');
          appError.status = response.status;
          appError.data = await response.json().catch(() => ({}));
          throw appError;
        }
        ...
        // If we got the app public settings successfully, continue without SDK-based auth
